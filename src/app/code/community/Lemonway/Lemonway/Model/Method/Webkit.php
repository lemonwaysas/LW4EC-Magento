 ...
 */
class Lemonway_Lemonway_Model_Method_Webkit extends Mage_Payment_Model_Method_Abstract
{


    protected $_code = 'lemonway_webkit';
    protected $_formBlockType = 'Lemonway_lemonway/form_webkit';
    protected $_infoBlockType = 'Lemonway_lemonway/info_webkit';
    ...
    public function assignData($data)
    {
        ...
        $info->setAdditionalInformation('register_card', $data->getOneclic() == "register_card" ? 1 : 0)->setAdditionalInformation('use_card', $data->getOneclic() == "use_card" ? 1 : 0);
        return $this;
    }
    ...
    /**
     * @return Lemonway_Lemonway_Helper_Data
     */
    public function getHelper()
    {
        return Mage::helper('Lemonway_lemonway');
    }
