 ...
 */
class Lemonway_Lemonway_Model_Adminhtml_Search_Wallet extends Varien_Object
{
    /**
     * Load search results
     *
     * @access public
     * @return Lemonway_Lemonway_Model_Adminhtml_Search_Wallet
     * @author Kassim Belghait kassim@Lemonway.com
     */
    public function load()
    {
        ...
        $collection = Mage::getResourceModel('Lemonway_lemonway/wallet_collection')
        ...
        foreach ($collection->getItems() as $wallet) {
            $arr[] = array(
                ...
                'type'        => Mage::helper('Lemonway_lemonway')->__('Wallet'),
