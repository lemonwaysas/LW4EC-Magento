 ...
 */
class Lemonway_Lemonway_Adminhtml_Lemonway_MoneyoutController extends Lemonway_Lemonway_Controller_Adminhtml_Lemonway
{
    ...
    {
        $this->loadLayout();
        $this->_title(Mage::helper('Lemonway_lemonway')->__('Lemonway'))
             ->_title(Mage::helper('Lemonway_lemonway')->__('MoneyOut'));
        $this->renderLayout();
    }
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('sales/Lemonway_lemonway/moneyout');
    }
    
    /**
     * 
     * @return Lemonway_Lemonway_Model_Method_Webkit
     */
    protected function getMethodInstance(){
    	return MAge::getSingleton('Lemonway_lemonway/method_webkit');
    }
}
